 ...
 */
public class FlinkDataStreamLoadToDoris {
    ...
    public static void main(String[] args) throws Exception{
        FlinkDataStreamLoadToDoris flinkDataStreamLoadToDoris = new FlinkDataStreamLoadToDoris();
        File file = new File(LOAD_FILE_NAME);
        flinkDataStreamLoadToDoris.load(file);
    }
}
